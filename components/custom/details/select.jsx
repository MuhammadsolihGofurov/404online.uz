  ...
  if (ui_type === "filter") {
    return (
      ...
      >
        ...
        <div
          ref={ref}
          className={`rounded-xl px-4 py-3 w-full border border-buttonGrey cursor-pointer flex justify-between items-center ${
        ...
        >
          <span
            className={`text-sm line-clamp-1 ${
              selectedOption ? "text-gray-900" : "text-inputPlaceholder"
            }`}
          >
            {selectedOption
            ...
            {options.length > 0 ? (
              options.map((opt) => {
                ...
                return (
                  ...
                  >
                    {opt?.label || opt?.full_name || opt?.name || opt?.title}
