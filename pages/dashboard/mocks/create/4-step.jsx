...
const QUESTION_TYPE_BADGES = {
  MCQ_SINGLE: { label: "MCQ • single", color: "bg-emerald-50 text-emerald-600" },
  MCQ_MULTIPLE: {
    label: "MCQ • multi",
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 px-6 py-12 text-center border border-dashed rounded-3xl border-slate-200 bg-slate-50">
      ...
      <p className="max-w-sm text-sm text-slate-500">
        Start by adding your first question. You can mix different question types
        and preview them before saving.
      </p>
    </div>
  );
}
